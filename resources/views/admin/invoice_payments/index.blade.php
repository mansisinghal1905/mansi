                        ...
                        <div class="card stretch stretch-full">
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="table table-hover data-table1 table stripe hover nowrap" id="invoicepaymentList">
                                        <thead>
                                            <tr>
                                                <th class="wd-30">
                                                   S.No.
...
<script type="text/javascript">
		$(function () {
			...
			// 	alert(id);
			// });
			var table = $('#invoicepaymentList').DataTable({
				processing: true,
				serverSide: true,
				...
				ajax: {
					url: "{{ route('admin.invoicepaymentAjax') }}",
					type: "POST",
					data: {
						search: $('input[name=invoice-id]').val(),
            ...
            $(document).on('change', '.invoiceStatusToggle', function () {
                ...
                $.ajax({
                    type: "POST",
                    url: @json(route('admin.ChangeInvoicePaymentStatus')),
        ...
        function deleteInvoicePayments(element) {
