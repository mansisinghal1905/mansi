                ...
                <div class="col-xxl-12">
                    <div class="card border-top-0 p-4">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8"><p class="text-muted mb-0">{{ $ticket->getAllHostCustomer->name}} </p></div>
                        </div>
                        @endif
                        <!-- <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8"><p class="text-muted mb-0">{!! ucfirst($ticket->department) !!}</p></div>
                        </div>
