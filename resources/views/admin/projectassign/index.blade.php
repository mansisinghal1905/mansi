            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Project Assign</li>
                    </ul>
                </div>
                <div class="page-header-right ms-auto">
                    <div class="page-header-right-items">
                        ...
                        <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                            ...
                            @if(Auth::user()->role == 1)
                            <a href="{{ route('admin.projects-assign.create') }}" class="btn btn-primary">
                                <i class="feather-plus me-2"></i>
                                <span>Create Project Assign</span>
                            </a>
                            @endif
                        </div>
                    </div>
                        ...
                        <div class="card stretch stretch-full">
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="table table-hover data-table1 table stripe hover nowrap" id="projectsassignList">
                                        <thead>
                                            <tr>
                                                <th class="wd-30">
                                                S.No.
...
<script type="text/javascript">
		$(function () {
			...
			var table = $('#projectsassignList').DataTable({
				processing: true,
				serverSide: true,
				...
				ajax: {
					url: "{{ route('admin.projectassignAjax') }}",
					type: "POST",
					data: {
            ...
            // for chnage status
            $(document).on('change', '.projectassignStatusToggle', function () {
                var id = $(this).attr("data-id");
                var status = $(this).is(':checked') ? 1 : 0;

                $.ajax({
                    type: "POST",
                    url: @json(route('admin.changeProjectAssignStatus')),
        ...
        function deleteProjectAssigns(element) {
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        success: function(response) {
                            Swal.fire(
                                'Deleted!',
                                'The project assign has been deleted.',
                                'success'
                            );
                        ...
                        error: function(response) {
                            Swal.fire(
                                'Failed!',
                                'There was an error deleting the project assign.',
                                'error'
                            );
                        }
                    });
